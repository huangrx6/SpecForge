const contractByArtifact = {
  ...
  ui_design: {
    ...
    produce: ["01-spec/ui-design.md", "Design Contract JSON with color_system and foundation_system", "component contract files when needed", "state matrix", "prototype or N/A evidence"],
  ...
  technical_design: {
    ...
    read: ["requirements", "ui design when applicable", "Design Contract JSON with color_system and foundation_system when UI applies", "component contract files", "wiki architecture", "official docs for new technology"],
  ...
  tasks: {
    ...
    read: ["requirements", "ui design", "Design Contract JSON with color_system and foundation_system", "component contract files", "technical design", "wiki context", "workflow schema"],
  ...
  implementation: {
    ...
    read: ["approved tasks", "Design Contract JSON with color_system and foundation_system when UI applies", "component contract files", "spec review evidence", "wiki entries", "current git status"],
  ...
  verification: {
    ...
    read: ["test cases", "Design Contract JSON with color_system and foundation_system when UI applies", "component contract files", "code review notes", "tasks", "CI / local / Playwright / logs"],
