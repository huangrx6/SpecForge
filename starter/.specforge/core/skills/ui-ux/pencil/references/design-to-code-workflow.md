...
## Step 1: Read Confirmed SpecForge UI Direction

**MANDATORY.** Before any design or code generation work, read the confirmed SpecForge UI direction. This provides:
...
- Read the confirmed SpecForge UI direction and apply its aesthetic guidelines to the generated code
...
- Skip SpecForge UI design guidance — it is mandatory for both design and code generation
