...
## 8. Backend Engineering Design

> 只在影响面为 yes 时展开。API 契约写第 10 节，数据结构写第 11 节。
...
## 12. Permission, Config, Jobs & Integration Impact
