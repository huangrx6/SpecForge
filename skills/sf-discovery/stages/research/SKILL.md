...
- `.specforge/core/skills/brainstorm/references/research-source.md`（需要当前事实、版本、来源质量、冲突处理、证据覆盖度或依赖关系查证时）
...
3. 需要外部事实或多来源综合时，参考 `research-source` 的本地事实、来源索引、证据契约、冲突处理和覆盖度要求组织来源、关键发现、争议和进一步研究空白；版本敏感事实必须实时核验。
