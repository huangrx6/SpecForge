...
`sf-code-review` 仍是唯一 code_review gate 入口。需要补充安全、性能、正确性、可维护性或测试覆盖检查维度时，按 `references/code-review-playbook.md#外部 code-reviewer 联动` 使用 `.specforge/core/skills/code-reviewer/SKILL.md`。
