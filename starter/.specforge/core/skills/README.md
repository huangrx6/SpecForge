...
| `research/` | 当前事实查证和多来源研究综合 | `brainstorm-search`, `deep-research` |
...
| `brainstorm-search` | `research/brainstorm-search` | Brainstorm 阶段的当前事实查证、来源选择、证据表和未查证项 | `00-intake/brainstorm.md#当前事实与研究证据` |
...
- 当前事实、法规、价格、版本、竞品、AI provider 或新闻会影响 brainstorm 取舍时，先参考 `brainstorm-search` 建立证据表；需要共识/争议综合时再参考 `deep-research`。
