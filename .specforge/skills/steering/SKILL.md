---
name: steering
description: SpecForge 内部 steering 技能。用于大型或 brownfield 变更前刷新 .specforge/knowledge 下的长期项目上下文和架构现实。
---

# Steering Skill

本技能用于大型变更、brownfield 项目接入或长期知识过期时，刷新 `.specforge/knowledge/`。它描述当前现实，不写未来愿望。

## 读取

- 当前代码库入口、目录结构、配置和核心模块。
- 现有 `.specforge/knowledge/`。
