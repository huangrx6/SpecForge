...
function testRegistrySingleActiveRemoval() {
  const registry = `active:\n  - id: CHG-20260512-001-demo\n    title: Demo\n    type: FEATURE\n    status: INTAKE\n    path: .specforge/changes/active/CHG-20260512-001-demo\n\nblocked: []\narchive: []\n`;
  const next = normalizeEmptyActive(removeRegistryEntry(registry, "CHG-20260512-001-demo"));
  assert.equal(next.includes(".specforge/changes/active/CHG-20260512-001-demo"), false);
...
function testRegistryKeepsOtherActiveEntries() {
  const registry = `active:\n  - id: CHG-20260512-001-first\n    title: First\n    type: FEATURE\n    status: INTAKE\n    path: .specforge/changes/active/CHG-20260512-001-first\n  - id: CHG-20260512-002-second\n    title: Second\n    type: FEATURE\n    status: INTAKE\n    path: .specforge/changes/active/CHG-20260512-002-second\n\nblocked: []\narchive: []\n`;
...
function testArchiveAppend() {
  ...
  const entry = makeArchiveRegistryEntry("CHG-20260512-003-demo", yaml, ".specforge/changes/archive/CHG-20260512-003-demo");
