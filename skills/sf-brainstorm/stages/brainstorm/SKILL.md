...
- 执行配置：Brainstorm mode、Execution profile、Brainstorm profile、Case study depth、Discussion depth、Package skills used、External references used、N/A section reason。
- 问题框架。
