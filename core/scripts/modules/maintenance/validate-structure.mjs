...
const sourceRequiredPaths = [
  ...
  "core/scripts/wiki-update-plan.mjs",
  "core/scripts/wiki-hydrate.mjs",
  ...
  "core/scripts/lib/wiki-plan.mjs",
...
const projectRequiredPaths = [
  ...
  ".specforge/core/scripts/lib/wiki-plan.mjs",
  ...
  ".specforge/core/scripts/wiki-update-plan.mjs",
  ".specforge/core/scripts/wiki-hydrate.mjs",
...
const requiredAnyPathGroups =
  layout.kind === "project"
    ? [
        ...
        [".specforge/wiki/external-interfaces.md"],
        [".specforge/wiki/config-env.md"],
        [".specforge/wiki/security-auth.md"],
        [".specforge/wiki/jobs-events.md"],
      ]
    : [];
