...
| `requirements` | `requirements` | Requirements | 行为契约主能力包；把 brief / brainstorm / PRD / research / gap / wiki 当前事实转成可测试 REQ / AC / NFR / 边界 / 影响面 / 下游 handoff | `01-spec/requirements.md` |
...
| `code-intelligence` | `code-intelligence` | 全阶段 | 跨阶段代码智能主能力包；用 Wiki-first、bounded context、provider freshness、graph_facts、impact / affected tests 和 Wiki 回写候选支撑现有代码事实 | `00-intake/brief.md`、`01-spec/requirements.md`、`01-spec/technical-design.md`、`01-spec/tasks.md`、`03-implementation/report.md`、`04-code-review/code-review-v1.md`、`05-verification/report.md`、`.specforge/wiki/*.md` |
