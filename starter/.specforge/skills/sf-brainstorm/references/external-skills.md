...
| 当前事实、版本、价格、依赖、竞品、AI provider、漏洞或法规会影响取舍 | `brainstorm-search` | `.specforge/core/skills/research/brainstorm-search/SKILL.md`；按需读 `references/source-index.md`、`references/evidence-contract.md`、`references/dependency-version-map.md` | 搜索问题、来源类型、证据表、版本依赖关系、置信度、未查证项 | `brainstorm.md#当前事实与研究证据`、`#问题地图`、`#方案对比` |
